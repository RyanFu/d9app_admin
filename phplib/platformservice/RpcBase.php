...
use \Phplib\Thrift;
use \Phplib\Thrift\Transport\TBufferedTransport;
use \Phplib\Thrift\Protocol\TBinaryProtocol;

require_once($GLOBALS['THRIFT_ROOT_LIB'] . '/Thrift.php');
require_once($GLOBALS['THRIFT_ROOT_LIB'] . '/transport/TBufferedTransport.php');
require_once($GLOBALS['THRIFT_ROOT_LIB'] . '/protocol/TBinaryProtocol.php');
require_once(PLATFORM_SERVICE_PATH_LIB . '/RpcConfig.php');
