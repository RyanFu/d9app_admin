...
use \Phplib\Thrift\Transport\TTransport;
use \Phplib\Thrift\Transport\TTransportException;
Use \Phplib\Thrift\TException;

require_once($GLOBALS['THRIFT_ROOT_LIB'] . '/transport/TTransport.php');
