...
namespace Phplib\Thrift\Packages;

use \Phplib\Thrift\TType;
use \Phplib\Thrift\TApplicationException;
use \Phplib\Thrift\TMessageType;
use \Phplib\Thrift\Protocol\TProtocol;
use \Phplib\Thrift\Protocol\TProtocolException;
...
class MlsStorageClient implements MlsStorageIf {
  ...
  public function recv_UniqRowGetUniq()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_UniqRowGetUniq_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  public function recv_UniqRowGetMulti()
  {
    ...
    if ($bin_accel)
    {
        $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_UniqRowGetMulti_result', $this->input_->isStrictRead());
    }
    else
    {
      $rseqid = 0;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_UniqRowGetMultiEx_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_MultiRowGetUniq_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_GetQueryData_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_UniqRowGetMultiSharding_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_MultiRowGetUniqSharding_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_GetQueryDataSharding_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_UniqRowGetMultiKey_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_UniqRowGetMultiKeyEx_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_MultiRowGetUniqKey_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_MultiRowGetMultiKey_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_QueryRead_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_ReadFromMaster_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_BatchSql_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_PreStmtRead_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_QueryWrite_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_PreStmtWrite_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_Insert_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_Update_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\MlsStorage_Delete_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          'var' => 'key_val',
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\AnyVal',
          ),
        4 => array(
          'var' => 'column_names',
          'type' => TType::STRING,
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\UniqRowGetUniqResp',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        4 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => 'Phplib\Thrift\Packages\BoolOperation',
            ),
          ),
        5 => array(
          'var' => 'column_names',
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\UniqRowGetMultiResp',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\MultiRowGetUniqResp',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\QueryReadResp',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        6 => array(
          ...
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\QueryConditions',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\MultiRowGetMultiResp',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\BatchSqlResp',
          ),
        );
    }
    if (is_array($vals)) {
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => 'Phplib\Thrift\Packages\QueryWriteResp',
          ),
        );
    }
    if (is_array($vals)) {
