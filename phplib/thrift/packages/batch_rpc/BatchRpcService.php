...
class BatchRpcServiceClient implements BatchRpcServiceIf {
  ...
  public function recv_batchHttpReq()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Phplib\Thrift\Packages\BatchRpcService_batchHttpReq_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => 'Phplib\Thrift\Packages\ZooRequest',
            ),
          ),
        );
    }
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => 'Phplib\Thrift\Packages\ZooResponse',
            ),
          ),
        );
    }
