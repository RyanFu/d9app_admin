...
namespace Phplib\Thrift\Protocol;

use \Phplib\Thrift\TType;
 ...
 * Protocol exceptions
 */
class TProtocolException extends \Phplib\Thrift\TException {
  const UNKNOWN = 0;
...
abstract class TProtocol {
  ...
  static $TBINARYPROTOCOLACCELERATED = 'Phplib\Thrift\Protocol\TBinaryProtocolAccelerated';
